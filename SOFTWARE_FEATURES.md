...
This document describes the application from a user's point of view: what the app does and why it is useful.

## What the app does

Playlist Predator turns a YouTube playlist or chaptered video into a clean, trackable study and watch experience. Instead of treating the source like a long, messy list of videos, it shows how much time it really takes and lets you manage your progress with clear states.

## User-facing features

- Analyze any YouTube playlist from a link or playlist ID.
- Analyze a normal YouTube video and turn description timestamps into chapter rows when chapters are not embedded on the page.
- See total video count, total duration, remaining time, and speed-based time estimates.
- Mark videos as done, skipped, or set them back to rewatch.
- Keep progress even if you refresh the page.
...
- Saves time by summarizing long playlists up front.
